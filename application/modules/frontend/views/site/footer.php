    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?= base_url("auths/logout")?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="<?php echo base_url().'layouts/admin/summernote/summernote-bs4.js';?>"></script>
  <script src="<?= base_url("layouts/admin/vendor/jquery-easing/jquery.easing.min.js")?>"></script>
  <script src="<?= base_url("layouts/admin/js/sb-admin-2.min.js")?>"></script>
